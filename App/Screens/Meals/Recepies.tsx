...
const Recepies = (props: any) => {
  const loading = useSelector(selectMealDetailLoader);
  ...
  useEffect(() => {
    ...
    return () => {
      dispatch(actions.resetDetailData());
    };
  }, [props.route.params.id]);
  const data: any = useSelector(selectMealsDetails);
    ...
    <SafeAreaView style={[global.wrap]}>
      <View style={[global.wrap, { padding: 30 }]}>
        <BackHeader
          ...
          RightIcon={undefined}
          goback={GOBack}
          rightIconOnPress={() => handleChat(data._id)}
        />
        {data?.englishName && !loading ? (
          <ScrollView
            ...
            <View style={{ marginBottom: 50 }}>
              ...
              <View style={styles.container}>
                ...
                <View style={styles.box}>
                  ...
                  <Text style={styles.description}>{data?.cookTime} Min</Text>
                </View>

                {/* Third box */}
                <View style={styles.box}>
                  <Text style={styles.title}>Total Time</Text>
                  <Text style={styles.description}>{data?.totalTime}Min</Text>
                </View>
              </View>
